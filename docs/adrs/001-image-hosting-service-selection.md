...
2. 蓄積画像のストレージが25GBに近づいてきた場合（Cloudinaryの有料プランは$89/月〜と高額なため）
3. Cloudflare Workersでのエッジ処理が必要になった場合
4. Cloudflareエコシステムとの統合による技術的メリットが明確になった場合
5. 動画コンテンツの大量配信が必要になった場合
