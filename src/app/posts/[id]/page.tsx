  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <Link href="/" className="text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 mb-12 inline-flex items-center gap-2 text-sm transition-colors">
