...
- [ ] 見出し部分をハッシュにし、Blueskyのドキュメントのようなhoverでアイコンを表示しクリック可能にする
  - https://docs.bsky.app/docs/advanced-guides/intent-links
  - アニメーションもいらんか
  - ハッシュ、日本語だとどうしよう問題がある。指定できるとうれしい
- [ ] リンクは見た目がリンクとわかるよう、下線つきで文字色も変える
- [ ] Shareボタンはpointer変える。最後のやつ何かわからん。Bluesky入れてほしい
- [ ] h2には下線を引きたい
